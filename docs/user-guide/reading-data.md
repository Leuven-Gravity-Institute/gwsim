...
This guide explains how to read and work with GWF (frame file) data generated by
gwmock.
...
gwmock generates data in GWF (frame file) format. To read data from a frame
file:
