...
def upload_command(
    ...
    Examples:
        # Single file
        gwmock repository upload 123456 --file data.gwf

        # Multiple files
        gwmock repository upload 123456 --file data1.gwf --file data2.gwf --file metadata.yaml
    """
    import logging
    ...
    if failed_count == 0:
        if sandbox:
            console.print("[cyan]Next:[/cyan] gwmock repository update <id> --metadata-file <file> --sandbox")
        else:
            console.print("[cyan]Next:[/cyan] gwmock repository update <id> --metadata-file <file>")
    else:
