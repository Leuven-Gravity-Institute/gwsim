...
def register_commands() -> None:
    ...
    from gwmock.cli.repository.create import create_command
    from gwmock.cli.repository.delete import delete_command
    from gwmock.cli.repository.download import download_command
    from gwmock.cli.repository.list_depositions import (
        list_depositions_command,
    )
    from gwmock.cli.repository.metadata.main import metadata_app
    from gwmock.cli.repository.publish import publish_command
    from gwmock.cli.repository.upload import upload_command
    from gwmock.cli.repository.verify import verify_command
